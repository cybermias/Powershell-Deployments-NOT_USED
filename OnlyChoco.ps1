...
$command = 'choco install tightvnc -ia "SET_ALWAYSSHARED=1 VALUE_OF_ALWAYSSHARED=1 SET_DISCONNECTACTION=1 VALUE_OF_DISCONNECTACTION=1 SET_USEVNCAUTHENTICATION=0 VALUE_OF_USEVNCAUTHENTICATION=0" -y -force'
$command 
